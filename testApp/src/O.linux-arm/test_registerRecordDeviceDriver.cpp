...
epicsShareExtern dset *pvar_dset_devTestBlockInp;
...
epicsShareExtern void (*pvar_func_asynExampleRegister)(void);
epicsShareExtern void (*pvar_func_echoDriverRegister)(void);
epicsShareExtern void (*pvar_func_addrChangeDriverRegister)(void);
epicsShareExtern void (*pvar_func_interposeInterfaceRegister)(void);
