...
epicsShareExtern dset *pvar_dset_devAiTestGpib;
...
epicsShareExtern dset *pvar_dset_devAoTestGpib;
...
epicsShareExtern dset *pvar_dset_devBiTestGpib;
...
epicsShareExtern dset *pvar_dset_devBoTestGpib;
...
epicsShareExtern dset *pvar_dset_devLiTestGpib;
...
epicsShareExtern dset *pvar_dset_devLoTestGpib;
...
epicsShareExtern dset *pvar_dset_devMbbiTestGpib;
...
epicsShareExtern dset *pvar_dset_devMbboTestGpib;
...
epicsShareExtern dset *pvar_dset_devSiTestGpib;
...
epicsShareExtern dset *pvar_dset_devSoTestGpib;
...
epicsShareExtern void (*pvar_func_echoDriverRegister)(void);
...
{
    const char *bldTop = "/media/data/home/rp/code/EPICS/asyn";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"testGpibSerial_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
