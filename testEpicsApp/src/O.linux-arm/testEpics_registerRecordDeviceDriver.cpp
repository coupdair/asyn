...
epicsShareExtern void (*pvar_func_int32DriverRegister)(void);
epicsShareExtern void (*pvar_func_uint32DigitalDriverRegister)(void);
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"testEpics_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
